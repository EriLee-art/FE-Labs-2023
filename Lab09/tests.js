...
describe('JS6 Lab Tests:', () => {
  ...
  describe(`Question 1b: Manage my wallet:`, () => {
    ...
    it(`#Should add money to wallet`, () => {
      ...
      const myWallet = new Wallet(19)
      myWallet.addMoney(3)

      expect(myWallet.money).to.equal(22)
    })
  ...
  describe(`Question 1d: Only wizards shall pass:`, () => {
    const movieCharacters = [
      ...
      },
      {
        name: `My Mom`,
        isAWizard: true,
        quote: `You know who else is a wizard?`
      }
    ]
    
    const onlyWizards = (arrayOfCharacters) => {
      return arrayOfCharacters.filter((characters) => characters.isAWizard == true)
    }
